	...
	void Load() 
	{
		if (GetGame().IsServer()) 
		{
			...
			{ // Config file does not exist, create default file
				...
				LeftoverItems.Insert(new LeftoverItem("BloodBagIV", "Used_BloodBagIV", 1));
				LeftoverItems.Insert(new LeftoverItem("SalineBagIV", "Used_SalineBagIV", 1));
				LeftoverItems.Insert(new LeftoverItem("Morphine", "Used_Morphine", 1));
				LeftoverItems.Insert(new LeftoverItem("Epinephrine", "Used_Epinephrine", 1));
				LeftoverItems.Insert(new LeftoverItem("AntiChemInjector", "Used_AntiChemInjector", 1));
...
class LeftoverItem 
{
	...
	void LeftoverItem(string originalItemParam = "", string leftoverItemParam = "", int healthParam = 0)
	{
